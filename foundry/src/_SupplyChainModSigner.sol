...
//Posibles mejoras:
//Restaurar el uso de la pass del user??

// Función addParticipant:

//     No hay verificación de que el participant_id no exceda el límite máximo de uint256.
//     No hay comprobación de si ya existe un participante con la misma dirección o nombre de usuario.

// Función addProduct:

//     Solo permite a los "Manufacturer" añadir productos. Esto podría ser intencional, pero asegúrate de que sea el comportamiento deseado.
//     Devuelve 0 si el participante no es un "Manufacturer", lo cual podría confundirse con un ID de producto válido.

// Función newOwner:

//     No verifica si el producto existe antes de transferir la propiedad.
//     No comprueba si el _user1Id es realmente el propietario actual del producto.

// Verificación de firma:

//     La función _checkSigner parece correcta, pero asegúrate de que estés generando el hash y la firma correctamente en el cliente.

// Comparaciones de strings:

//     Usas keccak256(abi.encodePacked()) para comparar strings, lo cual es correcto, pero considera usar una función helper para mejorar la legibilidad.

// Visibilidad de funciones:

//     Algunas funciones como getParticipant y getProduct podrían ser external en lugar de public para optimizar el gas si solo se llaman externamente.

// Eventos:

//     Considera añadir más eventos, por ejemplo, para addParticipant y addProduct, para facilitar el seguimiento de estas acciones off-chain.

// Seguridad:

//     La función getParticipant devuelve la contraseña. Esto no es seguro y deberías considerar no almacenar contraseñas en el blockchain o, al menos, no devolverlas.

// Optimización de gas:

//     En newOwner, podrías ahorrar gas combinando las condiciones en un solo if con operadores lógicos OR (||).

// Manejo de errores:

//     Considera usar require con mensajes de error más descriptivos en lugar de simplemente devolver false en newOwner.
