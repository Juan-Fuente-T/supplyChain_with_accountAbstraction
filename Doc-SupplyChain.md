...
8.  Instalación de Foundry (No es necesario instalarlo constantemente, solo en caso de no estar ya instalado. Y si se desea tener jusntos front y back, que no es necesario.)
...
- Despliegue en local con Anvil (una de las funcionalidades de Foundry): A estudiar.
